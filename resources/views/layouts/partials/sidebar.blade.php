      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="{{ route('dashboard.kelola.plant') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-orange-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap group-hover:text-orange-800">Plants</span>
            </a>
         </li>
            <li>
               ...
               <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-orange-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"  fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap group-hover:text-orange-800">Orders</span>
               </a>
            </li>
            <li>
               <a href="{{ route('dashboard.kelola.delivery') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-orange-100 dark:hover:bg-gray-700 group">
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap group-hover:text-orange-800">Deliveries</span>
               </a>
            </li>
         <li>
            <a href="{{ route('dashboard.kelola.customer') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-orange-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap group-hover:text-orange-800">Customers</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-orange-100 dark:hover:bg-gray-700 group">
               <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-orange-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 8h11m0 0L8 4m4 4-4 4m4-11h3a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-3"/>
               </svg>
               <span class="flex-1 ms-3 whitespace-nowrap group-hover:text-orange-800">Sign In</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-orange-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap group-hover:text-orange-800">Sign Up</span>
            </a>
         </li>
      </ul>
   </div>
